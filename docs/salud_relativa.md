# Salud relativa: Urgencias

Propuesta experimental publicada en `salud-relativa-urgencias`, sobre `impacto-grave-total` (beefea8362b5ef05b850085c36a788fda83d31fe).
...
**Consultorios de urgencias**. Se suman exclusivamente los registros REPS del grupo **CONSULTORIOS**, descripción **Urgencias**. No se suman sedes, prestadores, camillas, salas, ambulancias ni otras categorías a esta capacidad.

Base observada: **2022-11-05**, no 2026. 901 territorios DIVIPOLA con una base positiva; 1521 registros de capacidad aceptados. Es capacidad registrada, pública y privada, no demostración de capacidad operativa al momento del sismo. Las áreas no municipalizadas de la base DANE se distinguen por su código, sin atribuirlas a la cabecera.
...
La unidad mostrada es **puntos/consultorio de urgencias**, nunca porcentaje. Un cociente superior a 1 es admisible porque numerador y denominador son unidades distintas. El puntaje normalizado 0–100 compara cocientes; **100 no significa pérdida del 100% de la atención**.
...
|---|---:|---:|---:|---:|
| Atrato | 9 / 9 | Sin base positiva registrada | Sin dato / Sin dato | Sin dato |
| San José Del Palmar | 1 / 1 | 1 | 1.0000 / 1.0000 | 6.2500 |
| Pereira | 34 / 34 | 42 | 0.8095 / 0.8095 | 5.0595 |
| Santiago de Cali | 10 / 10 | 179 | 0.0559 / 0.0559 | 0.3492 |
| Armenia | 9 / 5 | 18 | 0.5000 / 0.2778 | 2.4306 |
...
Enfoca capacidad física de consulta urgente; no equivale a camas de observación, personal disponible ni atenciones por día. La ausencia de registro no se trata como cero y la menor cobertura puede afectar comparaciones.
